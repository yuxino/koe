(() => {
  ...
  shadow.innerHTML = `
    <style>
      ...
      .translated { margin: 0; font-size: clamp(17px, 2vw, 24px); line-height: 1.3; letter-spacing: .02em; text-shadow: 0 2px 14px rgba(0, 0, 0, .4); }
      .original { margin: 6px 0 0; font-size: clamp(13px, 1.5vw, 17px); line-height: 1.25; color: rgba(251, 244, 223, .78); letter-spacing: .02em; text-shadow: 0 1px 10px rgba(0, 0, 0, .45); }
